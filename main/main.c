...
static TaskHandle_t app_audio_pipeline_task_handle;

static const char *TAG = "APP";

void app_main(void) {
    xTaskCreatePinnedToCore(
        app_audio_pipeline_task, "VIB Audio Pipeline Task",
        APP_AUDIO_PIPELINE_TASK_STACK_SIZE, APP_AUDIO_PIPELINE_TASK_PARAM_COUNT,
        APP_AUDIO_PIPELINE_TASK_PRIORITY, &app_audio_pipeline_task_handle,
